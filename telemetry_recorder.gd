...
func _build_dancer_sample(dancer: Dancer) -> Dictionary:
	return {
		...
		"partner_carry_velocity": _vector2_for_json(dancer.partner_carry_velocity),
...
func _build_dancer_configuration(dancer: Dancer) -> Dictionary:
	return {
		...
		"movement_mode": "original_hold_partner_carry",
		"movement_linear_damping": dancer.movement_linear_damping,
		"movement_response": dancer.movement_response,
		"partner_carry_decay": dancer.partner_carry_decay,
		"double_hold_carry_decay": dancer.double_hold_carry_decay,
		"carry_transition_rate": dancer.carry_transition_rate,
