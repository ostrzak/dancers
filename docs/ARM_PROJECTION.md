...
forward on the corrected side. The black man has a small white forelock and
...
adduction and elbow flexion, reaching 120 degrees at full tuck; blocked requests
do not rotate the palm farther.
...
The largest mesh is then retained. The slim male abdomen is slightly shallower
to avoid a thin rim beside the face; the full abdomen endpoint is unchanged.

The abdomen half-width varies from 13 to 24 px; its forward edge from 12 px
(man) or 14 px (woman) to 26 px. Clothing scales with the band, while the head, mechanical skeleton, and
